...
The correspondance between the two data types is captured by the function $f : T -> P(L^*)$ given by :\\
...
\begin{gather*}
 \post(addword^{DictA}) = \domt = \domto \cup \{v\in L^* \mid v\leq w\} \And t = t_{0}\text{ }\cup \\
